...
epatterns = []
##TRUE POSITIVES
epatterns.append('([A-Za-z.]+)@([A-Za-z.]+)\.edu') #provided
epatterns.append('([A-Za-z.]+)\s\s@\s\s([A-Za-z.]+)\.edu') #fixes dabo
epatterns.append('([A-Za-z.]+)@([A-Za-z.]+)\.EDU') #fixes Cheriton
epatterns.append('([A-Za-z.]+) AT ([A-Za-z.]+) DOT edu') #fixes subh
...
#FALSE POSITIVES
epatterns.append('([A-Za-z.]+) at ([A-Za-z;]+)edu') #jks added to fp
epatterns.append('([A-Za-z.]+) [at]+ ([A-Za-z.]+)\.edu') #jure and plotkin added to fp
...
ppatterns = []
#TRUE POSITIVES
ppatterns.append('(\d{3})-(\d{3})-(\d{4})') #provided
ppatterns.append('(?:[(])\d{3})(?:[)])[ ]*(\d{3})-(\d{4})') #bgirod
ppatterns.append('(?:[[])(\d{3})(?:[]])\s(\d{3})-(\d{4})') #nass
ppatterns.append('(\d{3}) (\d{3}) (\d{4})') #pal
ppatterns.append('(\d{3}) (\d{3})-(\d{4})') #shoham
ppatterns.append('(?:[(])(\d{3})(?:[)])(\d{3})-(\d{4})') #tim
